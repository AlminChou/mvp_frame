...
public class RetrofitException extends RuntimeException {
    ...
    public static RetrofitException noConnectivityError(IOException exception) {
        return new RetrofitException(exception.getMessage(), null, null, Kind.NOCONNECTIVITY, exception, null);
    }
